...
- [ ] Опрос датчиков через подсистему `Modbus`
    - [v] Дефолтные настройки портов `8N1@57600`
    - [v] Игнорировать настройки порта, если они изменены с компа.
    - [ ] Начать поиск датчиков аналогично подсистеме `i2c`. 
    - [ ] 1 дефолтный способ скнирования, если кто-то ответил, обходим известные датчики и пробуем подходит или нет.