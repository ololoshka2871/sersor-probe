...
- [ ] Modbus bridge
    ...
    - [ ] Прием из Virtual COM длинных сообщений, более 1 пакета путем прогнозирования их длины по коду функции (в первом пакете)
    - [ ] Декодирование запросов в `modbus_core::rtu::server::decode_request()`
    - [ ] Запрос оборачивается в статус и кладется в общую очередь на отправку.